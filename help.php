...
if(isset($_POST['help_name'])){
    ...
    if($n!='' && $c!='' && $m!=''){
        try {
            ...
            $flash = 'Message sent! Sasagot kami agad sa '.$c;
        } catch(Exception $e){ $flash = 'Error sending message'; }
    }
}
...
<div class="help-wrap">
    ...
    <div style="background:#fff; border:1px solid #e5e5e5; border-radius:14px; padding:22px; margin-bottom:16px;">
        ...
        <details style="border:1px solid #eee; border-radius:10px; padding:14px 16px; margin-bottom:10px;" <?= ($q=='' || strpos('login order', $q)!==false || strpos('kailangan ba mag-login para umorder', $q)!==false) ? 'open' : '' ?>>
        ...
        <details style="border:1px solid #eee; border-radius:10px; padding:14px 16px; margin-bottom:10px;" <?= ($q!='' && (strpos('delivery fee bayad', $q)!==false || strpos('magkano delivery', $q)!==false)) ? 'open' : '' ?>>
        ...
        <details style="border:1px solid #eee; border-radius:10px; padding:14px 16px; margin-bottom:10px;" id="sell" <?= ($q!='' && strpos('benta farmer', $q)!==false) ? 'open' : '' ?>>
